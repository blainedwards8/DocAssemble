...
export const INITIAL_SNIPPETS = [
    { id: 'alim-1', category: 'Alimony', title: 'No Alimony', content: '1. Alimony: Neither party shall be awarded alimony or spousal support, now or in the future. Both parties acknowledge they are self-supporting.' },
    { id: 'cust-1', category: 'Child Custody', title: 'Standard Child List', content: '1. Minor Children: The following children are subject to this decree:\n{#foreach children}  * **{name}**, born on {dob}\n{/foreach}' }
];

export const INITIAL_RAW_TEMPLATE = `# DECREE OF DIVORCE\n\nIn the matter of the marriage of **{petitioner_name}** and **{respondent_name}**, the Court enters the following orders.\n\n[[Alimony Provisions|Alimony]]\n\n[[Children Provisions|Child Custody]]\n\nThis decree shall be effective immediately upon signing by the Honorable Judge presiding over this case.`;
